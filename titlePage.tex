...
\newcommand{\yourName}{Gamage Amanda Sheron}
...
{\fontsize{16pt}{16pt} \selectfont \mythesisTitle \vspace{2.40cm} \par}
\vspace{0.90cm}
{\fontsize{16pt}{16pt} \selectfont Advisor Prof. Seong-Lyun Kim \vspace{2.56cm} \par}
{\fontsize{16pt}{15pt}
\selectfont
