...
\newcommand{\committeeMemberOne}{Committee Chair: Prof. Seong-Lyun Kim}
\newcommand{\committeeMemberTwo}{Committee Member: Prof.  Jeonghun Park }
\newcommand{\committeeMemberThree}{Committee Member: Prof. Jemin Lee}
...
\large{\fontsize{13pt}{24pt}
Dynamic Spectrum Sharing Using Deep Learning and Generative Artificial Intelligence Models
}
\vspace{2.97cm}

\large{\fontsize{13pt}{24pt}
	This Certifies that the Master’s Thesis of \approvalAuthor  is Approved.
}
